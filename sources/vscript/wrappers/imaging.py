...
class v_vdomimaging(generic):
    ...
    def v_createfont(self, *arguments):
        ...
        self._imaging.create_font(
            **adapt(arguments, adaptors, name="createfont"))
        return v_mismatch
    ...
    def v_writetext(self, *arguments):
        ...
        self._imaging.write_text(
            **adapt(arguments, adaptors, require=1, name="writetext"))
        return v_mismatch

    def v_crop(self, x, y, w, h):
        self._imaging.crop(x.as_integer, y.as_integer,
                           w.as_integer, h.as_integer)
        return v_mismatch
