...
class VDOM_vhosting(object):
    def __init__(self):
        ...
        ret = managers.storage.read_object(
            VDOM_CONFIG["VIRTUAL-HOSTING-STORAGE-RECORD"])
        if ret:
    ...
    def sync(self):
        ...
        managers.storage.write_object(
            VDOM_CONFIG["VIRTUAL-HOSTING-STORAGE-RECORD"], self.__vhosting_data)
