...
class VDOM_resource(_DAVResource):
    ...
    def getMemberList(self):
        ...
        This default implementation calls self.getMemberNames() and self.getMember() for each of them.
        """
        ...
        if ret:
            ...
            if self.path == "/":
                ...
                get_properties.invalidate(
                    self._app_id, self._obj_id, posixpath.normpath(util.getUriParent(self.path)))
...
#     return r
    ...
    def createResourceInst(self, parent, name, environ):
        self._count_get_resource_inst += 1
        try:
            res = VDOM_resource(util.joinUri(
