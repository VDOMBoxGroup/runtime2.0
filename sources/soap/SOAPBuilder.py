...
from SOAPpy.Types import NoneType, StringType, UnicodeType, LongType, BooleanType
...
class SOAPBuilderE(SOAPBuilder):
    ...
    def dump(self, obj, tag=None, typed=1, ns_map={}):
        ...
        try:
            ...
            if type(obj) is LongType:
                obj_type = "integer"
            elif pythonHasBooleanType and type(obj) is BooleanType:
                obj_type = "boolean"
            else:
